...
function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] bg-secondary/20 blur-[120px] rounded-full pointer-events-none mix-blend-screen" />
        ...
        <div className="backdrop-blur-xl bg-base-100/40 p-8 rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] border border-white/10 relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            <motion.div 
              ...
              className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-tr from-primary to-secondary mb-4 shadow-lg shadow-primary/30"
            >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={loading}
                className="group relative w-full flex justify-center py-3.5 px-4 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary focus:ring-offset-[#0a0a0a] transition-all disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden"
              >
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-400">
              ...
              <NavLink to="/signup" className="font-medium text-primary hover:text-primary-focus hover:underline transition-colors">
                Create one now
              </NavLink>
            </p>
          </div>
